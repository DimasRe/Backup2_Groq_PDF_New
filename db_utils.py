...
def check_mysql_connection(host='localhost', user='new_user', password='12345', port=3307, database='chatbot_arpus'):
    """
...
def cleanup_mysql_connections(host='localhost', user='new_user', password='12345', port=3307, database='chatbot_arpus'):
    """
