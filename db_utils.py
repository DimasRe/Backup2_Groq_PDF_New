...
def check_mysql_connection(host='localhost', user='dia_arpus', password='12345', port=3307, database='chatbot_arpus'):
    """
...
def cleanup_mysql_connections(host='localhost', user='dia_arpus', password='12345', port=3307, database='chatbot_arpus'):
    """
